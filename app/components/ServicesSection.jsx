...
const ServicesSection = async () => {
  ...
  return (
    <div className="my-12 max-w-[774px]:my-6 px-6">
      <div className="flex flex-col justify-center items-center mb-6">
        <h2 className="text-xl sm:text-3xl md:text-4xl font-bold text-gray-800 sm:mb-2 mb-1">Our Service Area</h2>
        <span className="sm:text-base text-sm text-gray-600">the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </span>
      </div>
